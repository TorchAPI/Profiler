...
{
    public sealed class MySessionComponentBase_UpdateAfterSimulation
    {
        const string Category = ProfilerCategory.UpdateSessionComponents;
        static readonly Type SelfType = typeof(MySessionComponentBase_UpdateAfterSimulation);
        static readonly Type Type = typeof(MySessionComponentBase);
        static readonly MethodInfo Method = Type.InstanceMethod(nameof(MySessionComponentBase.UpdateAfterSimulation));
