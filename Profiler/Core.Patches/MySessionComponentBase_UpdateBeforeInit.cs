...
{
    public static class MySessionComponentBase_UpdateBeforeInit
    {
        const string Category = ProfilerCategory.UpdateSessionComponents;
        static readonly Type SelfType = typeof(MySessionComponentBase_UpdateBeforeInit);
        static readonly Type Type = typeof(MySessionComponentBase);
        static readonly MethodInfo Method = Type.InstanceMethod(nameof(MySessionComponentBase.UpdatedBeforeInit));
